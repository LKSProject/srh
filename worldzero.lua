...
local ao = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/LKSProject/srh/main/worldzero.lua"))()'
...
local aq = {
    ...
    ["Demon"] = {
        DemonDPS1 = {last = 0, cooldown = 1.8},
        DemonDPS2 = {last = 0, cooldown = 1.8},
        DemonDPS3 = {last = 0, cooldown = 1.8},
        DemonDPS4 = {last = 0, cooldown = 1.8},
        DemonDPS5 = {last = 0, cooldown = 1.8},
        DemonDPS6 = {last = 0, cooldown = 1.8},
        DemonDPS7 = {last = 0, cooldown = 1.8},
        DemonDPS8 = {last = 0, cooldown = 1.8},
        DemonDPS9 = {last = 0, cooldown = 1.8}
    }
}
local ar = {
    ["Mage"] = {
...
for aA, B in pairs(Y) do
    if game.PlaceId == B then
        ...
        cj.Countdown:GetPropertyChangedSignal("Text"):Connect(
            function()
                if cj.Countdown.Text == "Pick up your gold! (1)" then
                    ...
                    until cj.Chests.Visible and cj.Chests.Box1.Visible and cj.Chests.Box2.Visible and
                        cj.Chests.Box2.ChestImage.Select.Visible
                    repeat
        ...
        cj.OpenChest.Countdown:GetPropertyChangedSignal("Text"):Connect(
            function()
        ...
        cj.Chests.Box1.ChestImage.ChildAdded:Connect(
            function(ct)
        ...
        cj.Chests.Box2.ChestImage.ChildAdded:Connect(
            function(ct)
